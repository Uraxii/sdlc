...
- On revision: overwrite your section, don't duplicate.
- Skeptic + Security Auditor run concurrently post-Developer. Each appends independently.
...
**Friction points:** {what was hard/slow/wrong}
