...
2. Append Planning section. Document invariants that must hold before/after.

3. **Architect**: target structure, file boundaries, extraction strategy. Constraint: behavior identical before/after.

4. **Skeptic (design)**: verify scope is truly behavior-preserving. Flag any feature creep.
