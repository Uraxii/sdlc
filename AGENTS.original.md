...
- UX Designer mandatory on any UI change
- Friction Reviewer mandatory except docs-only

## Relay

Every run: create `sdlc/<task-slug>/relay.md`. Each role reads context before start, appends its section when done. Template: `templates/relay-template.md`.
