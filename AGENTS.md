# SDLC Plugin — Codex / OpenAI Agents
...
**Orchestrator**: coordinates multi-role pipelines. Spawns agents concurrently.
...
- SecAudit blocks all code-change modes post-Developer
- UX mandatory on UI changes
- Friction mandatory except docs-only

## Relay

Each run: create `sdlc/<task-slug>/relay.md`. Each role reads context, appends section when done. Template: `templates/relay-template.md`.