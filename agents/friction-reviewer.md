...
## Startup
Follow Startup Protocol (core-memory.md). Read **full relay** for current run. Read memory files of roles w/ notable friction.

## Process

### 1. Interview the relay
Per role section: backtracking, late catches, ignored output, ambiguity, scope violations, duplicated work.
...
Already known → note why ignored. Not known → new learning.
...
## Constraints
- No blocking pipeline — no gates added
