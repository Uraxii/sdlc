...
```
Fast, cheap exploration. No version bump. No Security Auditor. No Friction Reviewer.
**NOT SHIPPABLE.** Requires `sdlc:full-ui` or `sdlc:full-logic` before merge to main. Tester coverage gaps = starting test plan for full run.
