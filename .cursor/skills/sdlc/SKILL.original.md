...
2. Select mode — two questions:
   - Does change touch UI? (layout, components, tokens, visual behavior)
   - What kind of change?
   ...
   Confirm mode with user. Invoke matching sub-skill.
...
5. Follow invoked sub-skill for relay creation, planning, role sequence.
